...
// const unsigned int characterKeys[KEY_ROW_COUNT][KEY_COLUMN_COUNT] =
// {
//     // - = spacer for 2u key
...
//      {KC_NULL,        KEY_TILDE,         KEY_1,         KEY_2,         KEY_3,      KEY_4,   KEY_5,      KEY_6   },
//      {KEY_TAB,        KC_NULL,           KEY_Q,         KEY_W,         KEY_E,      KEY_R,   KEY_T,      KEY_Y   },
//      {KC_NULL,        KC_NULL,           KEY_A,         KEY_S,         KEY_D,      KEY_F,   KEY_G,      KEY_H   },
//      {KEY_LEFT_SHIFT, KC_NULL,           KEY_Z,         KEY_X,         KEY_C,      KEY_V,   KEY_B,      KEY_N   },
//      {KEY_LEFT_CTRL,  KC_NULL,           KEY_LEFT_GUI,  KEY_LEFT_ALT,  KEY_SPACE,  KC_NULL, KEY_SPACE,  KC_NULL }
// };
