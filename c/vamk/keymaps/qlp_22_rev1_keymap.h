...
static const uint8_t COLS[COLUMN_COUNT] =
{
    ...
    {
        { {HID_KEY_SPACE,0},  {KC_NULL,0},    {HID_KEY_TAB,0}, {KC_NULL,0},    {KC_NULL,0},     {KC_NULL,0}, {KC_NULL,0},            {KC_NULL,0},            {KC_NULL,0},          {KC_REPEAT,0},           {KC_NULL,0}, {HID_KEY_BACKSPACE,0} },
        { {HID_KEY_ESCAPE,0}, {HID_KEY_F2,0}, {HID_KEY_F5,0},  {HID_KEY_F8,0}, {HID_KEY_F11,0}, {KC_NULL,0}, {HID_KEY_ARROW_LEFT,0}, {HID_KEY_ARROW_DOWN,0}, {HID_KEY_ARROW_UP,0}, {HID_KEY_ARROW_RIGHT,0}, {KC_NULL,0}, {HID_KEY_ENTER,0}     },
    };
