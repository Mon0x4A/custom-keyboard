...
//TODO keyboard models need to be defined in separate files
#if IS_VOK_SL_MODEL
    ...
    static const struct keycode_definition_t L_HOLD_DELAY_KEYS[KEY_DEFINITION_ROW_COUNT][KEY_DEFINITION_COL_COUNT] =
    {
...
#if (IS_QLP_MODEL && IS_UNIFIED_KEYBOARD)
        ...
        static const uint8_t COL_0_PIN = 3;
        static const uint8_t COL_1_PIN = 4;
        static const uint8_t COL_2_PIN = 6;
        static const uint8_t COL_3_PIN = 7;
        static const uint8_t COL_4_PIN = 12;
        static const uint8_t COL_5_PIN = 13;
        static const uint8_t COL_6_PIN = 14;
        static const uint8_t COL_7_PIN = 16;
        static const uint8_t COL_8_PIN = 17;
        static const uint8_t COL_9_PIN = 21;
        static const uint8_t COL_10_PIN = 22;
        static const uint8_t COL_11_PIN = 26;
        static const uint8_t COL_12_PIN = 27;
        static const uint8_t COL_13_PIN = 28;
    ...
    {
        { {KC_NULL,0},          {KC_NULL,0}, {KC_NULL,0}, {KC_LM3,0},  {KC_LM4,0},  {KC_NULL,0}, {KC_NULL,0},             {KC_NULL,0},             {KC_NULL,0}, {KC_LM4,0},  {KC_LM3,0},  {KC_NULL,0}, {KC_NULL,0}, {KC_NULL,0} },
        { {HID_KEY_GUI_LEFT,0}, {KC_NULL,0}, {KC_NULL,0}, {KC_NULL,0}, {KC_NULL,0}, {KC_NULL,0}, {KC_NULL,0},             {KC_NULL,0},             {KC_NULL,0}, {KC_NULL,0}, {KC_NULL,0}, {KC_NULL,0}, {KC_NULL,0}, {HID_KEY_GUI_RIGHT,0} },
        { {KC_NULL,0},          {KC_NULL,0}, {KC_NULL,0}, {KC_NULL,0}, {KC_LM1,0},  {KC_LM2,0},  {HID_KEY_SHIFT_RIGHT,0}, {HID_KEY_SHIFT_RIGHT,0}, {KC_LM2,0},  {KC_LM1,0},  {KC_NULL,0}, {KC_NULL,0}, {KC_NULL,0}, {KC_NULL,0} },
    };
