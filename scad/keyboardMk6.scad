...
_kailhBackplateOffsetFromHousing = _housingBaseThickness + _backplateRiserHeight;
    ...
    union()
    {
        difference()
        {
            ...
            translate([_picoLengthPlacment+picoHousingCutoutLengthOffset,_picoWidthPlacment+picoHousingCutoutWidthOffset,_housingBaseThickness])
            {
                ...
                roundedCube(size=[_picoHousingBaseLength, _picoHousingBaseWidth, housingDepth*2], radius=_picoHousingLidBaseThickness, apply_to="zall");
            }
        }
    ...
    union()
    {
        difference()
        {
            difference()
            {
                ...
                translate([0,0,_picoHousingBaseDepth])
                    cube([_picoHousingBaseLength+(_housingWallThickness*2), _picoHousingBaseWidth+(_housingWallThickness*2), arbitraryDepth]);
            }
